...
public class ClassItemFragment extends BaseFragment implements RefreshCommonView.RefreshLoadMoreListener,BaseFragment.LazyLoadingListener{
    ...
    public static ClassItemFragment newInstance(String from) {
                ...
                holder.setText(R.id.tv_class_name, data.courseName)
                        ...
                        .setOnItemListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                intent.putExtra(StringUtils.ACTIVITY_DATA,data.courseId);
    ...
    public void postCourseStartList(){
    ...
    public void onEventMainThread(Bundle bundle) {
        ...
        switch (bundle.getInt(StringUtils.EVENT_ID)) {
            ...
            case IntegerUtil.EVENT_ID_11041:
            case IntegerUtil.EVENT_ID_11042:
