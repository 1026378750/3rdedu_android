 ...
 * 购买人数列表
 */
public class ParticipationActivity extends BaseActivity implements  RefreshCommonView.RefreshLoadMoreListener {
    ...
    public void initData() {
        ...
        adapter = new SimpleAdapter<BuyerBean>(mContext, messageArrayList, R.layout.item_coursebuyer) {
            ...
            protected void onBindViewHolder(TrdViewHolder holder, final BuyerBean data) {
                holder
                        .setVisible(R.id.ll_coursbuyer,false)
                        .setVisible(R.id.vp_course,false)
