...
public class TeacherInfo {
    ...
    public List<OneCourseArrayBean> getCourseList() {
        return courseList;
    }

    public void setCourseList(List<OneCourseArrayBean> courseList) {
        this.courseList = courseList;
    }

    private List<OneCourseArrayBean> courseList;
    private List<TeacherArea> teacherAreaList;
    private List<TeachingExperienceMode> teachingExperience;
    ...
    public List<TeachingExperienceMode> getTeachingExperience() {
        return teachingExperience==null?new ArrayList<TeachingExperienceMode>():teachingExperience;
    }

    public void setTeachingExperience(List<TeachingExperienceMode> teachingExperience) {
