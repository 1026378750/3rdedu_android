package com.shengzhe.disan.xuetangteacher.view;
...
public class X5WebView extends WebView implements View.OnKeyListener {
	...
	private void initWebViewSettings() {
		...
		webSetting.setDomStorageEnabled(true);// 打开本地缓存提供JS调用,至关重要
		webSetting.setAppCacheMaxSize(1024 * 1024 * 8);// 实现8倍缓存
		...
		stringBuilder.append(" 3rdedu/Android")
				.append(" token/122000");
