...
public class DropDownMenu extends RelativeLayout implements View.OnClickListener{
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        tabLayout.setLayoutParams(new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,SystemInfoUtil.dpTpPx(menuTitleHeight)));
    ...
    private void mainOvlayStatus(boolean isOpen){
        if(AppManager.getAppManager().currentActivity().getClass().getName().equals("com.shengzhe.disan.xuetangparent.activity.MainActivity")||AppManager.getAppManager().currentActivity().getClass().getName().equals("com.shengzhe.disan.xuetangteacher.activity.MainActivity")){
            Bundle bundle = new Bundle();
            bundle.putInt(BaseStringUtils.EVENT_ID, isOpen ? BaseIntegerUtil.CONDITION_POPUP_OPEN : BaseIntegerUtil.CONDITION_POPUP_ClOSE);
