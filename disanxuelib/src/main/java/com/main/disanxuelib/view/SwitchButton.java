...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (!mIsThumbUseDrawable && mThumbColor == null) {
            mThumbColor = UiUtils.generateThumbColorWithTintColor(mTintColor);
        ...
        if (!mIsBackUseDrawable && mBackColor == null) {
            mBackColor = UiUtils.generateBackColorWithTintColor(mTintColor);
    ...
    public void setBackColorRes(int backColorRes) {
        setBackColor( UiUtils.getColorStateList(backColorRes));
    }
