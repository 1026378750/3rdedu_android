...
public class CommonEditView extends LinearLayout {
    ...
    public CommonEditView(Context context, AttributeSet attrs) {
        ...
        //线条
        show_line = typedArray.getBoolean(R.styleable.CommonEditView_show_edit_line, false);
        ...
        limit_input_num = typedArray.getInteger(R.styleable.CommonEditView_limit_input_num, -1);
    ...
    private void setParameter() {
        if (!isTopEdit)
            return;
        LayoutParams params = new LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, SystemInfoUtil.dip2px(45) + SystemInfoUtil.getStatusBarHeight());
    ...
    public void setContentText() {
        ...
        if (limit_input_num!=-1)
            contentEdit.setFilters(new InputFilter[]{new InputFilter.LengthFilter(limit_input_num)});
    }

    public void setContentText(String mesg) {
        content_text = mesg;
        contentEdit.setText(content_text);
    }
    ...
    private void setLineParameter() {
        ...
        if (line_height != -1) {
            LayoutParams params = new LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, (int) line_height);
    ...
    public void setViewOnClick(int viewId, OnClickListener listener) {
        getChildView(viewId).setOnClickListener(listener);
    }
}
