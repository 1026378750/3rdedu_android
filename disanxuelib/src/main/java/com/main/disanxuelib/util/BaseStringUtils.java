...
public class BaseStringUtils {
    public static final String AppFromTeacher = "teacher";
    ...
    public static final String pageNameParent = "com.shengzhe.disan.xuetangparent";
    public static final String pageNameTeacher = "com.shengzhe.disan.xuetangteacher";
    ...
    public static final String ShareTeacher_Subject = "Subject";
    public static final String ShareTeacher_City = "Subject";
    public static final String Share_Grade = "Grade";
    ...
    public static final String Share_Phase = "Phase";
    public static final String Share_Phone = "Phone";
    public static final String duration = "duration";
    public static final String calendar = "calendar";
    public static final String singleTime = "singleTime";
    public static final String canTime = "canTime";
    public static final String scheduleList = "scheduleList";
    public static final String data = "data";
    public static final String num = "num";
    public static final String price = "price";
    public static final String teacher = "teacher";
    public static final String selectMet = "selectMet";
    public static final String selectDis = "selectDis";
    public static final String teachingMethod = "teachingMethod";
    ...
    public static final String btn_is_save = "save";
    public static final String btn_is_next = "next";
    ...
    public static final String select_course = "course";
    public static final String select_live = "live";
    public static final String select_clazz = "clazz";
    public static final String select_courseStatus = "courseStatus";
    ...
    public static final String System_Service_Phone = "400-000-5666";
    public static final String   RegistrationID="RegistrationID";
    public static final String   BadgeCount="BadgeCount";
    public static final String   MapBaiDu ="百度地图";
    public static final String   MapGaoDe ="高德地图";
    public static final String   MapTenXun ="腾讯地图";
    public static final String   MapGuGe ="谷歌地图";



    public static final String CAN_JOIN = "可插班";
    public static final String CAN_NOT_JOIN = "不可插班";
     ...
     * @return
     */
    public static int canJoinToInt(String canJoin){
        return canJoin.equals(CAN_JOIN)?1:0;
    }


    public static String canJoinToStr(int canJoin){
        return canJoin == 1?CAN_JOIN:CAN_NOT_JOIN;
    }
