...
public class LongPictureUtil {
    ...
    public LongPictureUtil(Context context, FragmentManager fragmentManager){
        viewHeight = 0;
        bitmapList.clear();
    ...
    private void resultPicture(){
        ...
        if (extroyBitmap != null) {
            ...
            canvas.drawBitmap(extroyBitmap, 0, height, paint);
        }
    ...
    private void getItemBitmap(View view) {
        ...
        } else if (view.getClass().getName().equals( "com.shengzhe.disan.xuetangparent.view.X5WebView")||view.getClass().getName().equals( "com.shengzhe.disan.xuetangteacher.view.X5WebView")) {

            getWX5ViewBitmap((WebView) view);
        } else if (view instanceof ViewPager) {

            getItemBitmap(((ViewPager) view).getChildAt(pagerIndex));
        } else if(view instanceof CommonCrosswiseBar|| view instanceof CommonCrosswise){
            getViewBitmap(view);
