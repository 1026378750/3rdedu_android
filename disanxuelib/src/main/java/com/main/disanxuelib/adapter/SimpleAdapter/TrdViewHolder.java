package com.main.disanxuelib.adapter.SimpleAdapter;
...
public class TrdViewHolder extends RecyclerView.ViewHolder {
    ...
    public TrdViewHolder setOnTouchListener(int viewId,
    ...
    public TrdViewHolder setOnLongClickListener(int viewId,
