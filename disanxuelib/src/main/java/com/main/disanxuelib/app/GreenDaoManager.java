...
import com.main.disanxuelib.gen.DaoMaster;
...
import com.main.disanxuelib.util.ZipUtil;
    ...
    public static GreenDaoManager getInstance() {
        if (greenDaoManager == null) {
            synchronized (GreenDaoManager.class) {
                if (greenDaoManager == null) {
                    String pageName = BaseApplication.getInstance().getAppFrom().equals(BaseStringUtils.AppFromParent) ? BaseStringUtils.pageNameParent:BaseStringUtils.pageNameTeacher;
