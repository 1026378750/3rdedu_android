...
public abstract class SystemPersimManage {
    ...
    public void CheckedFile(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (permissions.size() > 0) {
                requestPermissions(permissions, BaseIntegerUtil.PERMISSION_REQUEST_FILE);
                resultPerm(false,BaseIntegerUtil.PERMISSION_REQUEST_FILE);
                return;
            }
            resultPerm(true,BaseIntegerUtil.PERMISSION_REQUEST_FILE);
            return;
        }
        resultPerm(true,BaseIntegerUtil.PERMISSION_REQUEST_FILE);
    }
    ...
    public void CheckedLoaction(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (permissions.size() > 0) {
                requestPermissions(permissions,BaseIntegerUtil.PERMISSION_REQUEST_LOCATION);
                resultPerm(false,BaseIntegerUtil.PERMISSION_REQUEST_LOCATION);
                return;
            }
            resultPerm(true,BaseIntegerUtil.PERMISSION_REQUEST_LOCATION);
            return;
        }
        resultPerm(true,BaseIntegerUtil.PERMISSION_REQUEST_LOCATION);
    }
    ...
    public void CheckedCamera(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (permissions.size() > 0) {
                requestPermissions(permissions,BaseIntegerUtil.PERMISSION_REQUEST_CAMERA);
                resultPerm(false,BaseIntegerUtil.PERMISSION_REQUEST_CAMERA);
                return;
            }
            resultPerm(true,BaseIntegerUtil.PERMISSION_REQUEST_CAMERA);
            return;
        }
        resultPerm(true,BaseIntegerUtil.PERMISSION_REQUEST_CAMERA);
    }
    ...
    public void CheckedAlbum(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (permissions.size() > 0) {
                requestPermissions(permissions,BaseIntegerUtil.PERMISSION_REQUEST_ALBUM);
                resultPerm(false,BaseIntegerUtil.PERMISSION_REQUEST_ALBUM);
                return;
            }
            resultPerm(true,BaseIntegerUtil.PERMISSION_REQUEST_ALBUM);
            return;
        }
        resultPerm(true,BaseIntegerUtil.PERMISSION_REQUEST_ALBUM);
    }
