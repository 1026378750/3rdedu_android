...
public class CalendarView extends View {
    ...
    public CalendarView(Context context, OnSelectDateListener onSelectDateListener, float mmpHeight) {
        super(context);
        this.onSelectDateListener = onSelectDateListener;
        this.mmpHeight = mmpHeight;
    ...
    private void init(Context context) {
        ...
        touchSlop = CalendarUtils.getInstance().getTouchSlop(context);
        initAttrAndRenderer();
    }
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Math.abs(disX) < touchSlop && Math.abs(disY) < touchSlop) {
                    int cellHeight = (int)(mmpHeight/CalendarUtils.getInstance().getRowCell(renderer.getSeedDate().getYear(),renderer.getSeedDate().getMonth()));
