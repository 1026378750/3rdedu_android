...
public class AlbumActivity extends AppCompatActivity implements RefreshCommonView.RefreshLoadMoreListener, ListImageDirPopupWindow.OnImageDirSelected {
    ...
    private void setDates() {
        if (BaseApplication.getInstance().getAppFrom().equals(BaseStringUtils.AppFromParent)) {
            //家长端
            ...
            mTitle.setBackgroundRes(R.drawable.status_bgcolor);
            mTitle.setTitleTextColor(R.color.color_ffffff);
            mTitle.setRightButton(R.drawable.abc_ic_menu_moreoverflow_mtrl_alpha);
